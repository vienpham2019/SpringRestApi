...
//Note:
//
//Note that in some languages such as Java, there is no unsigned integer type. In this case, both input and output will be given as a signed 
//integer type. They should not affect your implementation, as the integer's internal binary representation is the same, whether it is signed 
//or unsigned.
//In Java, the compiler represents the signed integers using 2's complement notation. Therefore, in Example 2 above, the input represents the 
...
public class ReverseBits {
	...
	public int solution(int n) {
		...
		for(int i = 0; i < 32 ; i ++) {
			...
			n >>= 1;
			System.out.println("n : " + Integer.toBinaryString(n) + " integer : " + output);
			System.out.println();
		}
		return output; 
	}
	...
	public static void main(String [] args) {
		int n = 964176192; 
		System.out.println(new ReverseBits().solution(n));
	}
